package com.joseluis0218.laboratoriocalificado_api_rest.activities;
...
import com.joseluis0218.laboratoriocalificado_api_rest.services.ApiServiceGenerator;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        if (mediaFileUri == null) {
            ...
            MultipartBody.Part voucherPart = MultipartBody.Part.createFormData("voucher", file.getName(), requestFile);
            ...
            call = service.createSolicitudWithImage(correoPart, tipoPart, motivoPart, voucherPart);
        }
